...
module.exports = withSideEffect(reducePropsToState, handleStateChangeOnClient)(DocumentTitle);
...
var _NavLink = __webpack_require__(/*! ./NavLink */ "./src/js/Archive/NavLink.js");
...
var Archive = function Archive(_ref) {
  var posts = _ref.posts,
      termName = _ref.termName,
      termDescription = _ref.termDescription;
  return _react2.default.createElement(
    'nav',
    { className: 'SnapshotsArchive' },
    _react2.default.createElement(
      'div',
      { className: 'SnapshotsArchive__intro' },
      _react2.default.createElement('h1', { className: 'SnapshotsArchive__title', dangerouslySetInnerHTML: { __html: termName } }),
      ...
      _react2.default.createElement(
        'div',
        { className: 'SnapshotsArchive__social' },
        _react2.default.createElement(
          'a',
          {
            target: '_blank',
        ...
        _react2.default.createElement(
          ...
          {
            target: '_blank',
            href: 'https://twitter.com/intent/tweet?url=' + window.location.href + '&text=' + termDescription
          },
    ...
    posts.map(function (post, index) {
      return post.image && _react2.default.createElement(_NavLink2.default, _extends({ key: post.id, index: index }, post));
    })
  );
};
...
var getLargeOrMediumImageUrl = function getLargeOrMediumImageUrl(imageSizes) {
  return (0, _lodash2.default)(imageSizes, ['large', 'source_url'], (0, _lodash2.default)(imageSizes, ['medium', 'source_url'], ''));
};
...
var NavLink = function NavLink(_ref) {
  var index = _ref.index,
      ...
      imageSizes = _ref.image.media_details.sizes,
      slug = _ref.slug;
  return _react2.default.createElement(
    'div',
    { className: 'SnapshotsNavLink', style: { animationDelay: '.' + index + 's' } },
    _react2.default.createElement(
      _reactRouterDom.Link,
      { to: '/snapshot/' + slug + '/', href: '/snapshot/' + slug + '/', className: 'SnapshotsNavLink__inner' },
      _react2.default.createElement(
        'div',
        {
        ...
        _react2.default.createElement('h2', { dangerouslySetInnerHTML: { __html: title }, className: 'SnapshotsNavLink__title' })
      ),
      _react2.default.createElement('div', { className: 'SnapshotsNavLink__back', dangerouslySetInnerHTML: { __html: excerpt } })
    )
  );
};
...
NavLink.propTypes = {
  ...
  excerpt: _propTypes2.default.objectOf(_propTypes2.default.any).isRequired
};
...
var _Archive = __webpack_require__(/*! ./Archive */ "./src/js/Archive/Archive.js");

var _Archive2 = _interopRequireDefault(_Archive);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _Archive2.default;

/***/ }),

/***/ "./src/js/MiniNav/MiniNav.js":
/*!***********************************!*\
  !*** ./src/js/MiniNav/MiniNav.js ***!
  \***********************************/
/*! no static exports found */
...
var _MiniNavLink = __webpack_require__(/*! ./MiniNavLink */ "./src/js/MiniNav/MiniNavLink.js");

var _MiniNavLink2 = _interopRequireDefault(_MiniNavLink);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var MiniNav = function MiniNav(_ref) {
  var posts = _ref.posts,
      termName = _ref.termName,
      termSlug = _ref.termSlug;
  return _react2.default.createElement(
    'nav',
    null,
    _react2.default.createElement(
    ...
    posts.map(function (post) {
      return _react2.default.createElement(_MiniNavLink2.default, _extends({ key: post.id }, post));
    })
  );
};
...
var MiniNavLink = function MiniNavLink(_ref) {
  var slug = _ref.slug,
      title = _ref.title;
...
exports.default = MiniNavLink;

/***/ }),

/***/ "./src/js/MiniNav/index.js":
/*!*********************************!*\
  !*** ./src/js/MiniNav/index.js ***!
  \*********************************/
/*! no static exports found */
...
var _MiniNav = __webpack_require__(/*! ./MiniNav */ "./src/js/MiniNav/MiniNav.js");

var _MiniNav2 = _interopRequireDefault(_MiniNav);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _MiniNav2.default;

/***/ }),

/***/ "./src/js/Single/Single.js":
/*!*********************************!*\
  !*** ./src/js/Single/Single.js ***!
  \*********************************/
/*! no static exports found */
...
var Single = function Single(_ref) {
  ...
  return _react2.default.createElement(
    'article',
    null,
    _react2.default.createElement('h1', { dangerouslySetInnerHTML: { __html: title.rendered } }),
...
var _Single = __webpack_require__(/*! ./Single */ "./src/js/Single/Single.js");

var _Single2 = _interopRequireDefault(_Single);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _Single2.default;
...
var ROOT_SELECTOR = exports.ROOT_SELECTOR = '[data-wp-snapshots]';
var REST_PATH = exports.REST_PATH = 'wp/v2/snapshot';
var TAXONOMY = exports.TAXONOMY = 'snapshot-category';
...
var _startApp = __webpack_require__(/*! ./startApp */ "./src/js/startApp.js");
...
var appDidMount = exports.appDidMount = function appDidMount(termId) {
  return {
    type: 'APP_DID_MOUNT',
    termId: termId
  };
...
var _getRootUrl = __webpack_require__(/*! ../utils/getRootUrl */ "./src/js/utils/getRootUrl.js");

var _getMediaIdsFromPosts = __webpack_require__(/*! ../utils/getMediaIdsFromPosts */ "./src/js/utils/getMediaIdsFromPosts.js");

var _addImagesToPosts = __webpack_require__(/*! ../utils/addImagesToPosts */ "./src/js/utils/addImagesToPosts.js");

var _actions = __webpack_require__(/*! ./actions */ "./src/js/store/actions.js");
...
var effects = {
  APP_DID_MOUNT: function () {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 7:
              ...
              dispatch((0, _actions.receivePosts)(posts));
    ...
    return function APP_DID_MOUNT(_x, _x2) {
      return _ref.apply(this, arguments);
    };
  }(),

  RECEIVE_POSTS: function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee2(_ref4, _ref5) {
      var posts = _ref4.posts;
      var dispatch = _ref5.dispatch;
      var url, media, response, updatedPosts;
    ...
    return function RECEIVE_POSTS(_x3, _x4) {
...
exports.getPostBySlug = exports.getPosts = undefined;

var _lodash = __webpack_require__(/*! lodash.find */ "./node_modules/lodash.find/index.js");
...
var getPosts = exports.getPosts = function getPosts(state) {
  return (0, _lodash4.default)(state, 'posts', []);
};
 ...
 */
var getPostBySlug = exports.getPostBySlug = function getPostBySlug(state, slug) {
  return (0, _lodash2.default)(getPosts(state), { slug: slug });
};

/***/ }),

/***/ "./src/js/svg/Facebook.js":
/*!********************************!*\
  !*** ./src/js/svg/Facebook.js ***!
  \********************************/
/*! no static exports found */
...
var Facebook = function Facebook() {
  return _react2.default.createElement(
    "svg",
    { width: "24px", height: "24px", viewBox: "0 0 1792 1792", xmlns: "http://www.w3.org/2000/svg" },
    _react2.default.createElement(
      "title",
      null,
      "Facebook"
...
var _Facebook = __webpack_require__(/*! ./Facebook */ "./src/js/svg/Facebook.js");
...
var _Twitter = __webpack_require__(/*! ./Twitter */ "./src/js/svg/Twitter.js");
...
/***/ "./src/js/utils/addImagesToPosts.js":
/*!******************************************!*\
  !*** ./src/js/utils/addImagesToPosts.js ***!
  \******************************************/
/*! no static exports found */
...
exports.addImagesToPosts = undefined;
...
var addImagesToPosts = exports.addImagesToPosts = function addImagesToPosts(posts, media) {
  return posts.map(function (post) {
    return _extends({}, post, {
      image: (0, _lodash2.default)(media, { id: post.featured_media })
    });
  });
};
...
/***/ "./src/js/utils/getMediaIdsFromPosts.js":
/*!**********************************************!*\
  !*** ./src/js/utils/getMediaIdsFromPosts.js ***!
  \**********************************************/
/*! no static exports found */
...
exports.getMediaIdsFromPosts = undefined;
 ...
 */
var getMediaIdsFromPosts = exports.getMediaIdsFromPosts = function getMediaIdsFromPosts(posts) {
  return posts.reduce(function (ids, post) {
    var id = (0, _lodash2.default)(post, 'featured_media', null);
    if (id === null) {
      return ids;
    }
 ...
 */
var getRootUrl = exports.getRootUrl = function getRootUrl() {
  return (0, _lodash2.default)(global, ['wpApiSettings', 'root'], '');
};
...
/******/ });
//# sourceMappingURL=wp-snapshots.js.map